...
- **Unreleased / dev (fork additions):**
    - **Experimental Krea 2 RAW network training** is available through `krea2_train_network.py`, including built-in LoRA, LyCORIS LoRA/LoCon, LoHa and LoKr, Qwen3-VL output caching, Qwen-Image VAE latents, resolution-aware flow shifting, grouped-query attention, block swapping, and scaled fp8. See the [Krea 2 training guide](./docs/krea2_train_network.md).
