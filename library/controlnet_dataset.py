...
class ControlNetDataset(BaseDataset):
    ...
    def set_max_train_steps(self, max_train_steps):
        return self.dreambooth_dataset_delegate.set_max_train_steps(max_train_steps)

    def set_caption_debug_options(self, every_n_steps: int, max_length: int):
        return self.dreambooth_dataset_delegate.set_caption_debug_options(every_n_steps, max_length)
    ...
    def is_text_encoder_output_cacheable(self, cache_supports_dropout: bool = False):
        return self.dreambooth_dataset_delegate.is_text_encoder_output_cacheable(cache_supports_dropout)
    ...
    def new_cache_text_encoder_outputs_variants(
        ...
        return self.dreambooth_dataset_delegate.new_cache_text_encoder_outputs_variants(
            num_variants, models, accelerator
        )
